...
export const AvatarAdd = () => {
    return (
        <svg id="avatarAdd" version="1.1" x="0px" y="0px" viewBox="0 0 59 59" enableBackground="new 0 0 59 59">
            <g>
                <g>
			...
			c0.886,3.857,3.206,6.633,3.206,6.633v3.24C20.296,40.899,19.65,41.986,18.613,42.552z"/>
                    <g>
                        <path fill="#556080" d="M26.953,1.004C12.32,0.754,0.254,12.413,0.004,27.047C-0.138,35.344,3.56,42.801,9.448,47.76
                ...
                <g>
                    <circle fill="#21AE5E" cx="47" cy="46" r="8" />
                    <rect x="46" y="41" fill="#FFFFFF" width="2" height="10" />
                    <rect x="42" y="45.3" fill="#FFFFFF" width="10" height="2" />
                </g>
            </g>
        </svg>
    );
